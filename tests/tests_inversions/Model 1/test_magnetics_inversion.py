...
# nc_path = "arviz_data_magnetic_Nov_17_I_hierarchical.nc"
nc_path = "arviz_data_magnetic_Feb_05_I_hierarchical.nc"
...
class TestMagneticInversion:
    ...
    def test_magnetic_inversion(
            ...
            arviz_data_filename="arviz_data_magnetic_Feb_05_I_hierarchical.nc"
    ):
    ...
    def _setup_magnetic_geomodel(magnetic_data, simple_geo_model):
        ...
        xy_ravel = np.column_stack([
                ...
                np.full(len(magnetic_data), 500)  # Set Z to surface elevation
        ])
